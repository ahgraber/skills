...
**Purpose:** Agents reads description to decide which skills to load for a given task.
...
**Why this matters:** Testing revealed that when a description summarizes the skill's workflow, Agents may follow the description instead of reading the full skill content.
A description saying "code review between tasks" caused Agents to do ONE review, even though the skill's flowchart clearly showed TWO reviews (spec compliance then code quality).
...
**The trap:** Descriptions that summarize workflow create a shortcut Agents will take.
The skill body becomes documentation Agents skips.
