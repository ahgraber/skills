...
Always dispatch Agents 2 and 3 (quality, spec compliance).
...
### Template — Agent 4: Devil's Advocate (Challenge Pass)
...
Challenge pass (Agent 4, devil's advocate) dispatches separately after Step B completes.
